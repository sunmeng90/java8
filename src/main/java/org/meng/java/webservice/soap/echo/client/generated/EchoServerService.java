 ...
 * 
 */
@WebServiceClient(name = "EchoServerService", targetNamespace = "http://server.echo.soap.webservice.java.meng.org/", wsdlLocation = "http://localhost:8080/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVERSERVICE_QNAME = new QName("http://server.echo.soap.webservice.java.meng.org/", "EchoServerService");
    ...
    public EchoServer getEchoServerPort() {
        return super.getPort(new QName("http://server.echo.soap.webservice.java.meng.org/", "EchoServerPort"), EchoServer.class);
    }
    ...
    public EchoServer getEchoServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.echo.soap.webservice.java.meng.org/", "EchoServerPort"), EchoServer.class, features);
    }
